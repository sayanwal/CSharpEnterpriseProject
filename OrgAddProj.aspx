<%@ Page Title="" Language="C#" MasterPageFile="~/Organization.Master" AutoEventWireup="true" CodeBehind="OrgAddProj.aspx.cs" Inherits="CommunityESwap.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>
        Post a New Project</h2>
    <p>
...
&nbsp;<asp:TextBox ID="tbBudget" runat="server"></asp:TextBox>
             ...
             <tr>
                ...
                <td>
                 ...
                 &nbsp;&nbsp;
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="tbWeb" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
                 </td>
            </tr>
            <tr>
                <td style="width: 262px">
                ...
                <td>
                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="991px" CausesValidation="True">
                    ...
                    <br />
                    <asp:TextBox ID="tbSkills" runat="server" CssClass="mr-0" Width="393px"></asp:TextBox>
                    &nbsp;&nbsp;
            ...
            <tr>
                ...
                &nbsp;&nbsp;
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Required" ControlToValidate="tbDuration"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 262px">&nbsp;</td>
                <td>
    <asp:Button ID="btnAddPr" class="btn btn-info" runat="server" Text="Add" OnClick="btnAddProject_Click" />
                </td>
            </tr>
             </table>
